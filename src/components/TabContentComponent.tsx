...
const TabContentComponent = React.forwardRef<any, IProps>((props, ref) => {
  ...
  return (
    <div ref={ref} className={`bg-white z-10 intro overflow-y-auto bg-white h-[90%] w-[95%] sm:h-4/5 w-full sm:w-9/12 md:w-9/12 lg:w-7/12 drop-shadow-2xl p-12 transition-all ${classes.join(" ")}`}>
